...
export const fetchWebContentTool: ToolDefinition = {
    ...
    description: "Fetch and read the full content of a specific web page. Only use this when the search snippets don't provide enough information and you need the complete page content. Returns the text content of the page.",
    inputSchema: {
        type: "object",
        properties: {
            url: {
